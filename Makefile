...
# Definitions.
CC = avr-gcc
CFLAGS = -mmcu=atmega32u2 -Os -Wall -Wstrict-prototypes -Wextra -g -I. -I../../utils -I../../fonts -I../../extra -I../../drivers -I../../drivers/avr -std=c99
OBJCOPY = avr-objcopy
SIZE = avr-size
DEL = rm
...
bomb.o: bomb.c ../../drivers/avr/system.h ../../drivers/display.h ../../drivers/led.h setup.h player.h ../../drivers/avr/ir_uart.h bomb.h
	$(CC) -c $(CFLAGS) $< -o $@
